...
export const WrapperOptions = (props) => {
  ...
  return (
    <Fragment>
          ...
          {(tab) => (
            <Fragment>
              {tab.name === 'large' && (
                <Fragment>
                  ...
                  <WrapperResponsiveTabContent
                    ...
                    contentOffset={styleContentOffset}
                    containerWidth={styleContainerWidth}
                    containerSpacing={styleContainerSpacing}
                    spacingTop={styleSpacingTop}
                    spacingBottom={styleSpacingBottom}
                    hideBlock={styleHideBlock}
                    onChangeContentWidth={onChangeStyleContentWidth}
                    onChangeContentOffset={onChangeStyleContentOffset}
                    onChangeContainerWidth={onChangeStyleContainerWidth}
                    onChangeContainerSpacing={onChangeStyleContainerSpacing}
              ...
              {tab.name === 'tablet' && (
                <Fragment>
                  <br />
                  <strong className="notice-title">{__('Tablet Layout Options', 'ts-blog')}</strong>
                  <p>{__('This options will only control tablet screens options. If nothing is set, parent options will be used.', 'ts-blog')}</p>
                  <br />
                  <WrapperResponsiveTabContent
              ...
              {tab.name === 'mobile' && (
                <Fragment>
                  <br />
                  <strong className="notice-title ">{__('Mobile Layout Options', 'ts-blog')}</strong>
                  <p>{__('This options will only control mobile screens options. If nothing is set, parent options will be used.', 'ts-blog')}</p>
                  <br />
                  <WrapperResponsiveTabContent
      ...
      <PanelBody title={__('Block Colors', 'ts-blog')} initialOpen={false}>
        {onChangeStyleBackgroundColor &&
          <ColorPaletteCustom
            label={
              <Fragment>
      ...
      <PanelBody title={__('Block General', 'ts-blog')} initialOpen={false}>
        {onChangeId &&
          <TextControl
            label={
              <Fragment>
            ...
            help={__('Add Unique ID to the block.', 'ts-blog')}
            value={id}
            onChange={onChangeId}
          />
        }
        ...
        {onChangeAnchor &&
          <TextControl
            ...
            help={__('Adds data-anchor attribut to the block that is used for scroll to option.', 'ts-blog')}
            value={anchor}
