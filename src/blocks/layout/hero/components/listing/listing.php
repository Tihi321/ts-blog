...
?>
  <?php
  $hero_temaplate = ( $listing_type === 'lottie' ) ? locate_template( 'src/blocks/layout/hero/components/lottie/lottie.php' ) : locate_template( 'src/blocks/layout/hero/components/image/image.php' );
