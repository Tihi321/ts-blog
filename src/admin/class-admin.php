...
class Admin implements Service {
  ...
  public function enqueue_styles() {
    ...
    // Main style file.
    \wp_register_style( TB_THEME_NAME . '-style', $this->manifest->get_assets_manifest_item( 'applicationAdmin.css' ), [], TB_THEME_VERSION );
  ...
  public function enqueue_scripts() {
    ...
    \wp_register_script( TB_THEME_NAME . '-scripts', $this->manifest->get_assets_manifest_item( 'applicationAdmin.js' ), [], TB_THEME_VERSION, true );
    \wp_enqueue_script( TB_THEME_NAME . '-scripts' );

  }

  /**
   * Method that changes admin colors based on environment variable. Must have TB_ENV global variable set.
   *
