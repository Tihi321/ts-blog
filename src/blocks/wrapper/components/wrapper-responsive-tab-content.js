...
export const WrapperResponsiveTabContent = (props) => {
  ...
  const spacingOptions = [
    ...
    { label: __('Great (300px)', 'ts-blog'), value: 'great' },
    { label: __('Gigantic (280px)', 'ts-blog'), value: 'gigantic' },
    { label: __('Gargantuan (260px)', 'ts-blog'), value: 'gargantuan' },
    { label: __('Extensive (240px)', 'ts-blog'), value: 'extensive' },
    { label: __('Enormous (220px)', 'ts-blog'), value: 'enormous' },
    { label: __('Colossal (200px)', 'ts-blog'), value: 'colossal' },
    { label: __('Hugest (180px)', 'ts-blog'), value: 'hugest' },
    { label: __('Huger (160px)', 'ts-blog'), value: 'huger' },
    { label: __('Huge (140px)', 'ts-blog'), value: 'huge' },
    { label: __('Giant (120px)', 'ts-blog'), value: 'giant' },
    ...
    { label: __('None (0px)', 'ts-blog'), value: 'no-spacing' },
  ];
  ...
  return (
    <Fragment>
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Content Offset', 'ts-blog')}
            </Fragment>
          }
          help={__('Change content position inside a block.', 'ts-blog')}
          value={contentOffset}
          options={[
            { label: __('Not Set', 'ts-blog'), value: '' },
            { label: __('Content Spacing', 'ts-blog'), value: 'content-spacing' },
            { label: __('Content Spacing Small', 'ts-blog'), value: 'content-spacing-small' },
            { label: __('Right Edge', 'ts-blog'), value: 'right-edge' },
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Spacing Top', 'ts-blog')}
            </Fragment>
          }
          help={__('Change Block Spacing from the top.', 'ts-blog')}
          value={spacingTop}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Spacing Bottom', 'ts-blog')}
            </Fragment>
          }
          help={__('Change Block Spacing from the bottom.', 'ts-blog')}
          value={spacingBottom}
          options={spacingOptions}
      ...
      {onChangeHideBlock &&
        <ToggleControl
          label={__('Hide Block', 'ts-blog')}
          help={__('Toggle block visibility.', 'ts-blog')}
          checked={hideBlock}
